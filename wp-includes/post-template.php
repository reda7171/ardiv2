...
function get_the_content( $more_link_text = null, $strip_teaser = false, $post = null ) {
	...
	$page_no = isset($elements['page']) ? (int)$elements['page'] : 1;

// Sécuriser la valeur pour éviter un index négatif
if ($page_no > 0 && isset($elements['pages'][$page_no - 1])) {
    $content = $elements['pages'][$page_no - 1];
} else {
    $content = ''; // ou afficher une erreur / valeur par défaut
}
