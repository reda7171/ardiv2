...
<div class="heading d-flex align-items-center justify-content-between">
    ...
    <div class="add-export-btn">
        ...
        <li>
            ...
            <i class="houzez-icon icon-add-circle me-2"></i><?php esc_html_e('Add New Dealsssssssssss', 'houzez'); ?>
            </a>
        </li>
        </ul>
    </div>
...
<?php 
    ...
    <div class="stats-box">
    <?php esc_html_e("Don't have any deal at this moment.", 'houzez'); ?> <a href="#" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDeal" aria-controls="offcanvasDeal"><strong><?php esc_html_e('Add New Dealsssssssssss', 'houzez'); ?></strong></a>
    </div>
<?php 
} ?>
