...
Redux::setSection( $houzez_opt_name, array(
    ...
    'fields'        => array(
        ...
        array(
            ...
            'desc'     => '',
            'subtitle' => '',
            'default' => esc_html__('Premium', 'houzez')
        ),
        array(
            'id'       => 'cl_property',
            'type'     => 'text',
...
Redux::setSection( $houzez_opt_name, array(
    ...
    'fields'        => array(
        ...
        array(
            ...
            'default' => esc_html__("Support", 'houzez')
        ),
        ...
        array(
		 ...
		 array(
            ...
            'default' => esc_html__("Whatsapp", 'houzez')
        ),
		array(
            'id'       => 'dsh_telephone',
            'type'     => 'text',
            'title'    => esc_html__("Contactez nous sur Téléphone", 'houzez'),
            'default' => esc_html__("Contactez nous sur Téléphone", 'houzez')
        ),
		
		array(
            'id'       => 'dsh_email',
            'type'     => 'text',
            'title'    => esc_html__("Contactez-nous par Email", 'houzez'),
            'default' => esc_html__("Contactez-nous par Email", 'houzez')
        ),
		
		array(
            'id'       => 'dsh_ticket',
            'type'     => 'text',
            'title'    => esc_html__("Contactez-nous par Ticket", 'houzez'),
            'default' => esc_html__("Contactez-nous par Ticket", 'houzez')
        ),
		
		array(
            'id'       => 'dsh_support_appel_centre',
            'type'     => 'text',
            'title'    => esc_html__("Contactez-nous par Support appel centre", 'houzez'),
            'default' => esc_html__("Contactez-nous par Support appel centre", 'houzez')
        ),
