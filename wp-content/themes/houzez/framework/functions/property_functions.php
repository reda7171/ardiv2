...
if (!function_exists('houzez_get_listing_view_settings')) {
    ...
    function houzez_get_listing_view_settings($default_view_option) {
        ...
        $view_from_url = isset($_GET['view']) ? sanitize_text_field($_GET['view']) : '';
...
if (!function_exists('houzez_get_agent_data')) {
    function houzez_get_agent_data($prop_id, $type = 'agent') {
        ...
        // Récupérer tous les meta pour l’agent ou l’agence
        ...
        foreach ($fields as $field) {
            $value = get_post_meta($id, $meta_prefix . $field, true);
            if ($value) {
                $data[$field] = $value;
            }
        }
        ...
        // Ajouter toutes les meta récupérées
        $result = array_merge($result, $data);

        // Nettoyage des numéros de téléphone
        if (!empty($result['mobile'])) {
            $result['mobile_call'] = houzez_clean_phone_number($result['mobile']);
        }
        if (!empty($result['whatsapp'])) {
            $result['whatsapp_call'] = houzez_clean_phone_number($result['whatsapp']);
        }
        ...
        if(class_exists('Houzez_Fields_Builder')) {
			...
			echo '<script>
					...
					document.addEventListener("DOMContentLoaded", function() {
						let typeSelect = document.getElementById("property_type");
						
						let conditionField = document.querySelector("#details > div > div.block-content-wrap > div > div:nth-child(7)");
						let ageBienField = document.querySelector("#details > div > div.block-content-wrap > div > div:nth-child(8)");
						let standingField = document.querySelector("#details > div > div.block-content-wrap > div > div:nth-child(9)");
						let disponibiliteField = document.querySelector("#details > div > div.block-content-wrap > div > div:nth-child(10)");
						let nomEtageField = document.querySelector("#details > div > div.block-content-wrap > div > div:nth-child(11)");
						let syndicField = document.querySelector("#details > div > div.block-content-wrap > div > div:nth-child(12)");
						...
						if (typeSelect) {
							...
							// Cas par type
							if (typeSelect.value == 73) { 
								// Appartement à vendre
								disponibiliteField.display = "block";
								conditionField.style.display = "block";
								ageBienField.style.display = "block";
								standingField.style.display = "block";
								nomEtageField.style.display = "block";
								syndicField.style.display = "block";
							} 
							else if (typeSelect.value == 1527) { 
								// Autre Immobilier à vendre
								disponibiliteField.display = "block";
								conditionField.style.display = "none";
								ageBienField.style.display = "none";
								standingField.style.display = "none";
								nomEtageField.style.display = "none";
								syndicField.style.display = "none";
							} 
							else if (typeSelect.value == 61) { 
								// Bureaux à vendre
								standingField.style.display = "none";
								nomEtageField.style.display = "none";
								syndicField.style.display = "none";
							...
							else if (typeSelect.value == 1511) { 
								// Autre Immobilier à louer
								disponibiliteField.display = "block";
								conditionField.style.display = "none";
								ageBienField.style.display = "none";
								standingField.style.display = "none";
							...
							else if (typeSelect.value == 1517) { 
								// Appartement location vacances
								disponibiliteField.display = "block";
								conditionField.style.display = "block";
								ageBienField.style.display = "block";
								standingField.style.display = "block";
							...
							else if (typeSelect.value == 1519) { 
								// Maison location vacances
								disponibiliteField.display = "block";
								conditionField.style.display = "block";
								ageBienField.style.display = "block";
								standingField.style.display = "block";
							...
							else if (typeSelect.value == 1521) { 
								// Villas-Riad location vacances
								disponibiliteField.display = "block";
								conditionField.style.display = "block";
								ageBienField.style.display = "block";
								standingField.style.display = "block";
							...
							else if (typeSelect.value == 1513) { 
								// Villas-Riad colocation
								disponibiliteField.display = "block";
								conditionField.style.display = "block";
								ageBienField.style.display = "block";
								standingField.style.display = "block";
