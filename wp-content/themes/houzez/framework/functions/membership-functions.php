    ...
    function houzez_register_user_with_membership() {
        ...
        if( $user_id ) {
            ...
            if( !is_wp_error($user) ) {
                ...
                echo json_encode( array( 'success' => true, 'msg' => esc_html__('Inscrivez-vous avec succès, rediriger ...', 'houzez') ) );
                wp_die();
            }
        }
        wp_die();
    ...
    function houzez_get_user_current_package( $user_id ) {
        ...
        if( !empty( $package_id ) ) {
            ...
            echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('Ends On','houzez').' <span>'.esc_attr( $expired_date ).'</span></li>';
			 ...
			 echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('Nombre de Points','houzez').' <span>'.esc_attr( $points ).'</span></li>';
			
			 echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('Statistiques ','houzez').' <span>'.esc_attr( $stats ).'</span></li>';
			
			 echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('Badge ','houzez').' <span>'.esc_attr( $badge ).'</span></li>';
			
			 echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('Support Whatsapp','houzez').' <span>'.esc_attr( $whatsapp ).'</span></li>';
			
			 echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('Type Tableau de bord','houzez').' <span>'.esc_attr( $tableau_bord ).'</span></li>';
			
			 echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('Membres d équipe','houzez').' <span>'.esc_attr( $memeber_team ).'</span></li>';
			
			 echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('Prix du package','houzez').' <span>'.esc_attr( $package_price ).'</span></li>';
			
			 echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('Vitrine','houzez').' <span>'.esc_attr( $vitrine ).'</span></li>';
			
			 echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('Logo et Marque','houzez').' <span>'.esc_attr( $logo_marque ).'</span></li>';
			
			 echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('Plan','houzez').' <span>'.esc_attr( $plan ).'</span></li>';
			
			 echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('Visibilité','houzez').' <span>'.esc_attr( $visibilite ).'</span></li>';
			
			 echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('Statistiques ','houzez').' <span>'.esc_attr( $stats ).'</span></li>';
			
			 echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('En Cas de Renouvelement  ','houzez').' <span>'.esc_attr( $bonus_renouvellement ).'</span></li>';
				 
			
			
			
			echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('Support Par Email ','houzez').' <span>'.esc_attr( $support_email ).'</span></li>';
		
			 echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('Support ticket','houzez').' <span>'.esc_attr( $support_ticket ).'</span></li>';
			
			 echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('Support telephone','houzez').' <span>'.esc_attr( $support_telephone ).'</span></li>';
			
			 echo '<li class="list-group-item d-flex justify-content-between align-items-center">'.esc_html__('Support appel centre ','houzez').' <span>'.esc_attr( $support_appel_centre ).'</span></li>';
