	...
	function houzez_get_localization() {
		...
		$localization = array(
			...
			*------------------------------------------------------*/
			...
			'nombre_points'	=> esc_html__( ' points inclus', 'houzez' ),
			'vitrine'	=> esc_html__( ' Vitrine Exclusive', 'houzez' ),
			'logo_marque'	=> esc_html__( ' Logo & Marque', 'houzez' ),
			'stats'	=> esc_html__( ' Statistiques ', 'houzez' ),
			'support'	=> esc_html__( ' Support', 'houzez' ),
			'plan'	=> esc_html__( ' Plan', 'houzez' ),
			'visibilite'	=> esc_html__( ' Visibilité', 'houzez' ),
			'boosts'	=> esc_html__( 'Programmation des Boosts', 'houzez' ),	
			'badge_professionnel'	=> esc_html__( ' Badge ', 'houzez' ),
			'memeber_team'	=> esc_html__( ' Membre d equipe', 'houzez' ),
