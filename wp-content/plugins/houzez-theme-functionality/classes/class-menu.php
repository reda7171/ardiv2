...
class Houzez_Menu {
    ...
    public function setup_menu() {
        ...
        $menu_name = apply_filters('houzez_realestate_menu_label', esc_html__( 'Annonces', 'houzez-theme-functionality' ));
        add_menu_page(
            $menu_name,
            $menu_name,
            $this->capability,
