                                ...
                                foreach( $images_ids as $image_id ) { $i++;
                                    ...
                                    <div class="hs-gallery-v5-grid-item hs-gallery-v5-grid-item-01">
                                        <div class="property-banner-item" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                            <a data-slider-no="<?php echo esc_attr($i); ?>" data-image="<?php echo esc_attr($j); ?>" itemprop="contentUrl" <?php echo $dataModal; ?> class="img-wrap-1 <?php echo esc_attr($css_class); ?>">
                                                <img class="img-fluid" src="<?php echo esc_url($image_url); ?>" alt="<?php echo esc_attr($image_alt); ?>" itemprop="thumbnail">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <?php } ?>
                                        <div class="property-banner-item" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                            <a data-slider-no="<?php echo esc_attr($i); ?>" data-image="<?php echo esc_attr($j); ?>" itemprop="contentUrl" <?php echo $dataModal; ?> class="<?php echo esc_attr($css_class); ?> img-wrap-<?php echo esc_attr($i); ?>">
